    ...
    public class TblGstCodeDtlsBL : ITblGstCodeDtlsBL
    {
        ...
        public TblGstCodeDtlsTO SelectGstCodeDtlsTO(Int32 prodCatId, Int32 prodSpecId, Int32 materialId, Int32 prodItemId)
        {
            ...
            try
            {
                conn.Open();
                tran = conn.BeginTransaction();
                return TblGstCodeDtlsDAO.SelectGstCodeDtlsTO(prodCatId, prodSpecId, materialId, prodItemId, conn, tran);
            }
            catch (Exception ex)
            {
                return null;
        ...
        public static TblGstCodeDtlsTO SelectGstCodeDtlsTO(Int32 prodCatId, Int32 prodSpecId, Int32 materialId, Int32 prodItemId, SqlConnection conn, SqlTransaction tran)
        {
            return TblGstCodeDtlsDAO.SelectGstCodeDtlsTO(prodCatId, prodSpecId, materialId, prodItemId, conn, tran);
        }
