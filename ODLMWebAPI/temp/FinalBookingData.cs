...
namespace ODLMWebAPI.BL
{
            ...
            try
            {
                ...
                if (bookingTOList != null && bookingTOList.Count > 0)
                {
                    ...
                    foreach (var loadingSlipTO in bookingTOList)
                    {
                        ...
                        TempLoadingSlipInvoiceTO tempLoadingSlipInvoiceTO = TempLoadingSlipInvoiceDAO.SelectTempLoadingSlipInvoiceTOList( oldLoadingSlipId,oldInvoiceId, conn, tran);
    ...
    " ,@currentCdAplAmt " +
        ...
        private static int InsertFinalLoadingSlipInvoice(TempLoadingSlipInvoiceTO tempLoadingSlipInvoiceTO, SqlConnection conn, SqlTransaction tran)
        {
            SqlCommand cmdInsert = new SqlCommand();
            try
            {
        ...
        private static int ExecuteInsertionFinalLoadingSlipInvoiceCommand(TempLoadingSlipInvoiceTO tempLoadingSlipInvoiceTO, SqlCommand cmdInsert)
        {
...
" VALUES (" +
        ...
        public int DeleteTempLoadingData(int loadingId, SqlConnection conn, SqlTransaction tran)
        {
            ...
            try
            {
                ...
                {
                    TempLoadingSlipInvoiceTO tempLoadingSlipInvoiceTO = TempLoadingSlipInvoiceBL.SelectTempLoadingSlipInvoiceTOListByLoadingSlip(loadingSlipTO.IdLoadingSlip, conn, tran);
        ...
        private static int DeleteDispatchTempData(String delTableName, int delId, SqlConnection conn, SqlTransaction tran)
        {
            SqlCommand cmdDelete = new SqlCommand();
            ResultMessage resultMessage = new ResultMessage();
        ...
        private static int DeleteDispatchBookingTempData(String delTableName, Int32 delId, SqlConnection conn, SqlTransaction tran)
        {
            SqlCommand cmdDelete = new SqlCommand();
            ResultMessage resultMessage = new ResultMessage();
        ...
        public int CreateTempInvoiceExcel(List<TblInvoiceRptTO> tblInvoiceRptTOList, SqlConnection conn, SqlTransaction tran)
        {
            ...
            try
            {
                ...
                // Create azure storage  account connection.
                CloudStorageAccount storage_Account = CloudStorageAccount.Parse(Startup.AzureConnectionStr);
