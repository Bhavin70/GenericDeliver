        ...
        public ResultMessage SaveNewAlertInstance(TblAlertInstanceTO alertInstanceTO, SqlConnection conn, SqlTransaction tran)
        {
            ...
            try
            {
                    ...
                    else if (channelList[c].Key == (int)NotificationConstants.NotificationTypeE.EMAIL)
                    {
                        ...
                        if(userList!=null)
                        {
                            ...
                            if (!string.IsNullOrEmpty(userIds))
                            {
                                ...
                                userDCT = BL.TblUserBL.SelectUserEmailDCTByUserIdOrRole(userIds, true, conn, tran);
                            ...
                            if (!string.IsNullOrEmpty(roleIds))
                            {
                                ...
                                roleDCT = BL.TblUserBL.SelectUserEmailDCTByUserIdOrRole(roleIds, false, conn, tran);
                            ...
                            {
                                SendMailBL.SendEmailNotification(item);
                            }
                        }
                ...
                if (regDeviceDCT != null && regDeviceDCT.Count > 0)
                {
                    ...
                    VitplNotify.NotifyToRegisteredDevices(devices, notifyBody, notifyTitle);
                }
