...
namespace ODLMWebAPI.Controllers
{
    ...
    public class BookingController : Controller
    {
        ...
        public List<TblBookingsTO> GetDealerBookingHistory(Int32 dealerId , Int32 lastNRecords=4, Int32 bookingId = 0)
       {
        ...
        [HttpGet]
        public List<TblBookingsTO> GetAllBookingList(Int32 cnfId, Int32 dealerId,Int32 statusId,string fromDate,string toDate, String userRoleTOList, Int32 isConfirm = -1, Int32 isPendingQty = 0,Int32 bookingId = 0, Int32 isViewAllPendingEnq=0, Int32 RMId = 0,int orderTypeId=0,Boolean isFromEnquiryReport=false,Int32 districtId = 0, Int32 stateId = 0)
                {
            ...
            List<TblBookingsTO> tblBookingsTOList = _iTblBookingsBL.SelectBookingList(cnfId, dealerId, statusId, frmDt, toDt, tblUserRoleTOList, isConfirm, isPendingQty, bookingId, isViewAllPendingEnq, RMId, orderTypeId, isFromEnquiryReport, districtId, stateId);
      ...
      //  public List<PendingBookingRptTO> GetAllPendingBookingsForReport(Int32 cnfOrgId,Int32 dealerOrgId, string userRoleTO,int isTransporterScopeYn, int isConfirmed, string fromDate, string toDate,Boolean isDateFilter,Int32 brandId)
        ...
        [HttpGet]
        public List<TblBookingAnalysisReportTO> GetBookingAnalysisReport(DateTime startDate, DateTime endDate,Int32 distributorId,Int32 cOrNcId,Int32 brandId, int skipDate,int isFromProject =0,int stateId=0,int districtId=0)
        {
            return _iTblBookingsBL.GetBookingAnalysisReport(startDate, endDate, distributorId, cOrNcId, brandId, skipDate,isFromProject,stateId ,districtId);
        }
        #endregion
