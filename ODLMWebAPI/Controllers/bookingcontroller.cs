...
namespace ODLMWebAPI.Controllers
{
    ...
    public class BookingController : Controller
    {
        ...
        public List<TblBookingsTO> GetDealerBookingHistory(Int32 dealerId , Int32 lastNRecords=4, Int32 bookingId = 0)
       {
        ...
        [HttpGet]
        public List<TblBookingsTO> GetAllBookingList(Int32 cnfId, Int32 dealerId,Int32 statusId,string fromDate,string toDate, String userRoleTOList, Int32 isConfirm = -1, Int32 isPendingQty = 0,Int32 bookingId = 0, Int32 isViewAllPendingEnq=0, Int32 RMId = 0,int orderTypeId=0,Boolean isFromEnquiryReport=false,Int32 categoryType=1)
        {
            ...
            List<TblBookingsTO> tblBookingsTOList = _iTblBookingsBL.SelectBookingList(cnfId, dealerId, statusId, frmDt, toDt, tblUserRoleTOList, isConfirm, isPendingQty, bookingId, isViewAllPendingEnq, RMId, orderTypeId, isFromEnquiryReport,categoryType);
